...
{
public:
    alignas(simd_alignment) std::array<std::array<int16_t, HIDDEN_SIZE>, 2> accumulator;
...
struct Network
{
    alignas(simd_alignment) int16_t feature_weights[INPUT_WEIGHTS][HIDDEN_SIZE];
    alignas(simd_alignment) int16_t feature_bias[HIDDEN_SIZE];
    alignas(simd_alignment) int16_t output_weights[2][HIDDEN_SIZE];
    alignas(simd_alignment) int16_t output_bias;
};
